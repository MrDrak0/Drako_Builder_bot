...
const deleteServerCommand = {
    ...
    async execute({ interaction }) {
        ...
        const confirmed = await requestConfirmation(interaction, {
            ...
            description: 'This will permanently delete **every** channel, category and role in this server.\n' +
        ...
        const deletedChannels = channelsSnapshot.filter((c) => c !== null).length - failedChannels.length;
